...
public class ToMeFragment extends CustomFragment {
...
//            recvTimeLine.addItemDecoration(itemDecoration);
    ...
    private void loadTImeLine() {
        isLoading = true;
        Call<List<MissionItem>> CallMissionItems = AppController.getInstance().getDataManager().getMissionItemService().getToMeMissionItems(((ChannelActivity) getActivity()).getChannelId());
