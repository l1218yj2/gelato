...
//            recvTimeLine.addItemDecoration(itemDecoration);
    ...
    private void loadTImeLine() {
        isLoading = true;
        Call<List<MissionItem>> CallMissionItems = AppController.getInstance().getDataManager().getMissionItemService().getTimeLineMissionItems(((ChannelActivity) getActivity()).getChannelId());
